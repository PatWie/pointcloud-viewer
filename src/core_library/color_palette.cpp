...
Color::Color(QRgb rgb) : Color(QColor::fromRgb(rgb)) {}

Color::Color(QColor color) : color(color) {}

Color::Color(glm::vec3 rgb) : Color(glm::dvec3(rgb)) {}

Color::Color(glm::dvec3 rgb) : Color(QColor::fromRgbF(rgb.r, rgb.g, rgb.b)) {}

Color::Color(glm::u8vec3 rgb) : Color(glm::dvec3(rgb) / 255.) {}
...
QString Color::hexcode() const { return color.name(); }
...
Color::operator QColor() const { return color; }

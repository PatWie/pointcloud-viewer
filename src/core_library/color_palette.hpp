...
const Color aluminium[6] = {Color(0x2e3436), Color(0x555753), Color(0x888a85),
                            Color(0xbabdb6), Color(0xd3d7cf), Color(0xeeeeec)};

const Color grey[6] = {
    aluminium[0].with_saturation(0.), aluminium[1].with_saturation(0.),
    aluminium[2].with_saturation(0.), aluminium[3].with_saturation(0.),
    aluminium[4].with_saturation(0.), aluminium[5].with_saturation(0.)};
const Color cyan[3] = {blue[0].with_hue(0x00ffff), blue[1].with_hue(0x00ffff),
                       blue[2].with_hue(0x00ffff)};
const Color magenta[3] = {violet[0].with_hue(0xff00ff),
                          violet[1].with_hue(0xff00ff),
                          violet[2].with_hue(0xff00ff)};

...
// Class for storing a coordinate frame defined py position, uniform scale
// factor and rotation
struct frame_t final {
  ...
  static void _concatenate(glm::vec3* out_position, glm::quat* out_orientation,
                           float* out_scale_factor,
                           const glm::vec3& in_position_1,
                           const glm::quat& in_orientation_1,
                           float in_scale_factor_1,
                           const glm::vec3& in_position_2,
                           const glm::quat& in_orientation_2,
                           float in_scale_factor_2);
  static void _coordinate_from_matrix(glm::vec3* out_position,
                                      glm::quat* out_orientation,
                                      float* out_scale_factor,
                                      glm::mat4 transform);
  static void _transform_point(glm::vec3* out_point, const glm::vec3& position,
                               const glm::quat& orientation, float scale_factor,
                               const glm::vec3& in_point);
  static void _transform_direction(glm::vec3* out_direction,
                                   const glm::quat& orientation,
                                   const glm::vec3& in_direction);
  static void _to_mat4x3(float* out_mat, const glm::vec3& in_position,
                         const glm::quat& in_orientation,
                         float in_scale_factor);
  static void _to_mat4(float* out_mat, const glm::vec3& in_position,
                       const glm::quat& in_orientation, float in_scale_factor);
  static void _inverse(glm::vec3* out_position, glm::quat* out_orientation,
                       float* out_scale_factor, const glm::vec3& in_position,
                       const glm::quat& in_orientation, float in_scale_factor);
};

glm::quat remove_tilt(glm::quat);
frame_t remove_tilt(frame_t);

...
GlobalUniform::GlobalUniform()
    : vertex_uniform_buffer(sizeof(vertex_data_t),
...
void GlobalUniform::write(GlobalUniform::vertex_data_t vertex_data) {
  vertex_data_t& _vertex_data = *reinterpret_cast<vertex_data_t*>(
      vertex_uniform_buffer.Map(gl::Buffer::MapType::WRITE,
                                gl::Buffer::MapWriteFlag::INVALIDATE_BUFFER));

...
class KdTreeInspector final : public QObject {
  Q_OBJECT
  Q_PROPERTY(bool canBuildKdTree READ canBuildKdTree WRITE setCanBuildKdTree
                 NOTIFY canBuildKdTreeChanged)
  Q_PROPERTY(bool hasKdTreeAvailable READ hasKdTreeAvailable WRITE
                 setHasKdTreeAvailable NOTIFY hasKdTreeAvailableChanged)
  Q_PROPERTY(bool autoBuildKdTreeAfterLoading READ autoBuildKdTreeAfterLoading
                 WRITE setAutoBuildKdTreeAfterLoading NOTIFY
                     autoBuildKdTreeAfterLoadingChanged)
 public:
 ...
 signals:
  ...
  void kd_tree_inspection_changed(aabb_t active_aabb,
                                  glm::vec3 separating_point,
                                  aabb_t other_aabb);
 ...
 private:
  ...
  void set_current_point_for_the_kd_tree_inspection(
      size_t kd_tree_inspection_current_point);

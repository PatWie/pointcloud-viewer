...
class Camera final {
 public:
  frame_t frame = frame_t(
      ...
      remove_tilt(glm::quatLookAt(glm::normalize(-default_camera_position()),
                                  glm::vec3(0, 0, 1))));
  float aspect = 1.f;
  ...
  static glm::vec2 pixel_to_screenspace(glm::ivec2 pixel,
                                        glm::ivec2 viewport_size);

  static glm::vec2 clipspace_screenspace(glm::vec2 clipspace_point);
  static glm::vec2 screenspace_to_pixel(glm::vec2 screenspace_point,
                                        glm::ivec2 viewport_size);
